...
const CategoryDropdown = ({ handler }: PropsType) => {
  ...
  const key = "OPEN_CATEOGRY_SELECT_DROPDOWN";
  ...
  return (
    <div className="relative">
      ...
      >
        <h4 className="fs-base">{selectedCategory?.label}</h4>
      ...
      <div
        ...
        className={`!bg-white w-full max-w-[300px] sm:max-w-[380px] fixed flex flex-col mt-0 h-auto max-h-0 overflow-hidden z-[99999999999999999999] ${
          expand &&
          "!max-h-[250px] 2xl:!max-h-[368px] px-2 border border-[#0000001a] pt-[10px] pb-[11px] rounded-[20px] bg-white job-post-card-select-shadow"
        }`}
      >
