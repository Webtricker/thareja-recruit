import { OnboardingUserType } from "@/app/(public pages)/(without-header-footer)/onboarding/page";
type PropsType = {
  userType: OnboardingUserType;
  target: "CLIENT" | "FREELANCER";
};
const UserActiveCheckBox = ({ userType, target }: PropsType) => {
  return (
    <>
      {userType === target ? (
        <svg
...
export default UserActiveCheckBox;
