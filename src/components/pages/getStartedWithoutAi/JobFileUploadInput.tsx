...
const JobFileUploadInput = () => {
  ...
  return (
    <div className="relative">
      <h4 className="fs-md">Need help?</h4>

      {/* TODO: have to update the link according to need */}
      <button
        onClick={() => setShow(true)}
        className="text-[#005AFF] fs-md cursor-pointer py-5 block"
      >
      ...
      {show && (
        <Alert
          key="link error"
          hide={setShow}
          message="We couldn't find any page related to this link. It will be functional when it is available. Thank you."
        />
      )}
...
export default JobFileUploadInput;
