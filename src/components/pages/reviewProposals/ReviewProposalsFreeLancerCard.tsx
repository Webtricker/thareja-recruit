...
import { HeartFilledBlueSVG } from "../inviteFreelancers/Icons";

const InviteFreelancerButton = () => {
...
// ======== root component ===========
const ReviewProposalsFreeLancerCard = () => {
  const dispatch = useDispatch();
  const hanldeClick = () => {
    document.body.style.overflowY = "hidden";
    dispatch(setActiveFreelancerProfileModal(true));
          ...
          <div className="full mt-5 md:mt-[30px]">
            <p className="fs-base">
              ...
              <span>
                ...
                which has access to the website to get statistics. You may check
                out the sample article.
              </span>
              <Link
...
export default ReviewProposalsFreeLancerCard;
