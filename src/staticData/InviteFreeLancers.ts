export const earnedAmountItems: string[] = [
  "Any amount earned",
  "$1+ earned",
  "$100+ earned",
  "$1k+ earned",
...
export const hourlyRateItems: string[] = [
  "Any hourly rate",
  "$10 and below",
  "$10 - $30",
  "$30 - $60",
...
export const hoursBilledItems: string[] = [
  "Any hours",
  "1+ hours billed",
  "100+ hours billed",
  "1,000+ hours billed",
...
export const englishLevelItems: string[] = [
  "Any level",
  "Basic",
  "Conversational",
  "Fluent",
...
export const talentTypeItems: string[] = [
  "Freelancers & Agencies",
  "Freelancers",
  "Agencies",
];
export const lastActivityItems: string[] = [
  "Any time",
  "Within 2 weeks",
  "Within 1 month",
  "Within 2 months",
...
export const dropDownCategory: string[] = [
...
export const availableLanguageItems: string[] = [
  "Afrikaans",
  "Albanian",
  "Amharic",
  "Arabic",
